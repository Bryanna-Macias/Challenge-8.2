...
class Cli {
  ...
  // Updated the constructor to accept Truck and Motorbike objects
    ...
    inquirer
      ...
      .then((answers) => {
        const motorbike = new Motorbike(
          ...
          parseInt(answers.topSpeed),
          [
            new Wheel(answers.frontWheelDiameter, answers.frontWheelBrand), // Creating front wheel
            new Wheel(answers.rearWheelDiameter, answers.rearWheelBrand), // Creating rear wheel
          ]
        );
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (selectedVehicle.vin === truck.vin) {
          ...
          console.log(`Truck ${truck.make} is towing ${selectedVehicle.make}.`);
          this.performActions();
        }
      });
  }
      ...
      .prompt([
        {
          ...
          choices: [
            ...
            'Turn left',
            'Reverse',
            'Tow a vehicle', // Added option for towing
            'Perform wheelie', // Added option for wheelie
          ...
          if (this.vehicles[i].vin === this.selectedVehicleVin) {
            ...
            if (answers.action === 'Print details') {
              ...
              if (selectedVehicle instanceof Truck) {
                ...
                console.log(`${selectedVehicle.make} cannot tow other vehicles.`);
                this.performActions();
              }
